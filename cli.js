...
yargs
    ...
    .command({
        command: "watch-new-arch",
        describe: "Watch relative deps and install on change, reloading next dev process. Also launch auxilliary processes.",
        handler: relativeDeps.watchRelativeDepsNewArch
    })
    .command({
        command: "init",
